...
export default function CinematicPipeline() {
    ...
    useGSAP(() => {
        ...
        // --- ESCENA 1: ENTRADA DE DOCUMENTOS ---
        tl.to(".document-node", {
            top: "28vh",
            scale: 1,
            opacity: 1,
            ...
            // --- ESCENA 3: AVANZAN AL SCANNER L2 ---
            ...
            // Desaparecen dentro de la carpeta y estas brillan
